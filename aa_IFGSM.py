...
save_root_path = './adv_data/IFGSM_to_attack_' + opt.name
...
IFGSM = torchattacks.MIFGSM(model=model,image_datasets=image_datasets,eps=5/255.0,alpha = 1/255.0, steps = 15)
