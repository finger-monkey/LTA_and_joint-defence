...
parser.add_argument('--name', default='newDLe120', type=str, help='save model path')
...
save_root_path = './adv_data/LTA_to_attack_' + opt.name
...
LTA = torchattacks.LTA(model=model,eps=5/255.0,alpha = 1/255.0, steps = 15, momentum = 1.0)
